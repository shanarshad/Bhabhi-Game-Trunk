...
public class Card implements Comparable<Card> {
   ...
   */
   public Card( final Suit suit, final Rank rank /*final ImageIcon cardFace*/ ) {
      //cardImage = cardFace;
      suitValue = suit;
      rankValue = rank;
   }
   ...
   */
   public static String getFilename( final Suit suit, final Rank rank ) {
   ...
   */
   public boolean isSameAs( final Card card ) {
